...
function restart(){
    ...
    wrongSound();
    setTimeout(()=>{
        header.html("<h1 id='level-title'>Press Any Key to Start!</h1>");
        onMobile.html("<h4 class='mobile-adviser'> If you're on mobile, click anywhere to restart.</h4>");
